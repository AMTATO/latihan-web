            ...
            <div class="col-md-4">
                <form action="" method="post" class="form-container bg-white p-4 rounded-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mb-3" id="model" name="model" placeholder="BMW 3 Series Sedan" required>
                        <label class="form-label fs-5" for="harga">Harga</label>
                        <input type="text" class="form-control mb-3" id="harga" name="harga" placeholder="Rp 919.000.000" required>
                        <label class="form-label fs-5" for="cc">CC</label>
                        <input type="text" class="form-control mb-3" id="cc" name="cc" placeholder="1998 cc" required>
                        <label class="form-label fs-5" for="tenaga">Tenaga</label>
                        <input type="text" class="form-control mb-3" id="tenaga" name="tenaga" placeholder="184 hp" required>
                        <label class="form-label fs-5" for="transmisi">Transmisi</label>
                        <input type="text" class="form-control mb-3" id="transmisi" name="transmisi" placeholder="8-Speed Steptronic" required>
                        <div class="mb-3">
